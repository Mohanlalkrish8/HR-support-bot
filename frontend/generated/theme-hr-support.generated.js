...
import stylesCss from 'themes/hr-support/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_hr-support_componentCss']) {
    
    document['_vaadintheme_hr-support_componentCss'] = true;
  }
